...
5. 如果用户只是询问“记录了什么、做了多少、最近情况如何”等事实，不要求解释原因或提出分析，使用 query_memory。
6. 只有用户明确询问“为什么、原因、下降/改善原因、规律、问题分析、复盘”等，才使用 reflection。
...
- “我最近的学习情况怎么样？” → query_memory
- “我今天学习了多久？” → query_memory
- “最近为什么学习效率下降？” → reflection
- “帮我安排下周的学习” → planning
- “你好呀” → casual_chat
